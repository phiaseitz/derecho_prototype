  ...
  render: function(){
    return (
      <div className="tab">
        ...
        <input className= "email" type="text" defaultValue= "sophia.seitz@students.olin.edu"></input>
  		  <p className= "settings">  <br></br>Phone </p>
    		<div className = "phone">
    		   (<input type="text" defaultValue= "555" className="phone1" maxLength="3"></input>)
    		   <input type="text" defaultValue= "555" className="phone1" maxLength="3"></input>-
    		   <input type="text" defaultValue= "5555" className="phone2" maxLength="4"></input>
    		</div> 
        <br></br>
        <p className= "settings"> Best way to contact </p>
        <textarea className= "contact" rows="4" cols="50"></textarea>
        <div><br></br>
          <button type="submit" className="save-button" type="button">SAVE</button>
        </div>
    </div>
    )
  }
